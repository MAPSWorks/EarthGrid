...
#ifndef S2_EGPointUTIL_H_
#define S2_EGPointUTIL_H_
...
// (this is mainly useful for testing).
    bool ApproxEquals(const EGPoint& a, const EGPoint& b,
                      EG1DAngle max_error = EG1DAngle::Radians(1e-15));
...
// The result is not guaranteed to be unit length.
    EGPoint RobustCrossProd(const EGPoint& a, const EGPoint& b);
...
// #define S2_TEST_DEGENERACIES
  ...
  return EGPoint(0, 0, 1);
        ...
        return EGPoint(-0.0099994664350250197, 0.0025924542609324121,
                       0.99994664350250195);
#endif
    }
